          ...
          <header className="sticky top-0 z-40 border-b border-[var(--gh-border)] bg-[color:var(--gh-bg)]/80 backdrop-blur supports-[backdrop-filter]:bg-[color:var(--gh-bg)]/60">
            <div className="h-14 flex items-center gap-4">
              ...
              <div className="ml-auto flex items-center gap-3">
                <Link href="/public" className="inline-flex items-center h-6 text-sm text-[var(--gh-text-muted)] hover:text-[var(--gh-cyan)]">Public</Link>
                <Link href="/help" className="inline-flex items-center h-6 text-sm text-[var(--gh-text-muted)] hover:text-[var(--gh-cyan)]">Help</Link>
                <NavLinks />
                <ClientAuthMenu />
              </div>
            </div>
